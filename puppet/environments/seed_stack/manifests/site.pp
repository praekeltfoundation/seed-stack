...
class bootstrap_prepare {
  ...
  $dcos_installer_commands = [
    'cd /root/dcos',
    '[ -d dcos-cli-bootstrap ] || virtualenv dcos-cli-bootstrap',
    ...
    # We do this twice because it sometimes fails "due to concurrent access".
  ...
  $gen_conf = {
    ...
    'oauth_enabled' => 'false', # lint:ignore:quoted_booleans YAML string
    'telemetry_enabled' => 'false', # lint:ignore:quoted_booleans YAML string
  }
